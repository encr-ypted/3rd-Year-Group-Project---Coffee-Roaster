...
try:
    ...
    print(f"AI detector import failed: {exc}")
    SmartRoastAIDetector = None
...
try:
    ...
    if ENABLE_AI_GRAYSCALE and SmartRoastAIDetector is not None:
        try:
            ai_detector = SmartRoastAIDetector()
            ai_detector.open()
            print("AI grayscale detector ready")
        except Exception as exc:
            print(f"AI grayscale detector disabled: {exc}")
            ai_detector = None
    ...
    while True:
        ...
        try:
            ...
            if ai_detector is not None:
                try:
                    ai_result = ai_detector.infer_once(save_crop=False)
                    latest_mean_grayscale = ai_result.mean_grayscale
                except Exception as exc:
                    print(f"AI grayscale error: {exc}")
                    latest_mean_grayscale = None
