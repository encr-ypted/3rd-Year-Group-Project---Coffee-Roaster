"""
LEGACY — original standalone Pi script (blocking loop).

Use the FastAPI backend instead:
  • Dev (mock):  python api/main.py
  • Pi (GPIO):   ROASTER_HW=1 python api/main.py

Refactored logic lives in hardware/controller.py.
"""
